# Groove Vision AI → XIAO ESP32-S3 → T-SIM7080G-S3  
...
In addition to raw images, the system transports **inference metadata (INF)** generated by the Groove Vision AI model. This metadata is sent **inline with each frame** from the broker to the receiver and logged on the receiver side.
