...
/* ================================
   UART CONFIG (XIAO ↔ T-SIM7080G-S3)
   ================================ */
static constexpr uint32_t UART_BAUD = 921600;

// Locked to board pinout
static constexpr int UART_TX_PIN = 17;   // GPIO17 → U1TXD (P1.4)
static constexpr int UART_RX_PIN = 18;   // GPIO18 → U1RXD (P1.5)
...
void setup()
{
    ...
    Serial.println("=======================================");
    Serial.println(" T-SIM7080G-S3 | SSCMA UART BROKER ");
    Serial.println("=======================================");
    ...
    // Explicit I²C pins (locked)
    Wire.begin(3, 8);        // SDA=GPIO03 (P1.7), SCL=GPIO08 (P1.6)
